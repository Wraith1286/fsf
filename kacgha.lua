...
local kick = true
for _, v in ipairs({ 4055740561, 5440006876, 4645202717, 2411593291, 3595939119, 5250007575, 680226997, 1360277717, 5227017428, 5138219457, 3203584778, 4576640872, 2769269310, 7592817330, 904811621, 3252013546, 1382979785, 3213965848, 3969855889, 4993020254 }) do
...
setclipboard('loadstring(game:HttpGet("https://raw.githubusercontent.com/Wraith1286/nitrous/refs/heads/main/main.lua"))()')
...
local MainTab = Window:AddTab('Update')

MainTab:AddLabel("New update available. Delete this and upload the new one")
MainTab:AddLabel("Note: The script has been added to your clipboard")
MainTab:AddLabel("You do not need to ask for the new link")
MainTab:AddLabel("PC, ANDROID AND IOS SUPPORT. ENJOYYYY")
