...
local s = Vector2.new(510, 360)
if UserInputService.KeyboardEnabled then
	s = Vector2.new(510, 460)
end

local Window = library:AddWindow("Nitrous Lite | For Sul Only", {
	main_color = Color3.fromRGB(80, 144, 173),
	min_size = Vector2.new(510, 360),
	toggle_key = Enum.KeyCode.RightShift,
	can_resize = true,
})
...
local function PunchPlayer(targetPlayer, lh, rh, me)
	...
	if humanoid and tHead and humanoid.Health > 0 and lh and rh then
		...
		firetouchinterest(lh, tHead, 0)
        firetouchinterest(rh, tHead, 0)
		me:FireServer("punch", "leftHand")
		me:FireServer("punch", "rightHand")
        firetouchinterest(lh, tHead, 1)
        firetouchinterest(rh, tHead, 1)
